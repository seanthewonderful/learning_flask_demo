...
""" Web scraping - need redis info from Task stuff above """
...
@app.route("/add-scrape-task", methods=["GET", "POST"])
def add_scrape_task():
    ...
    return render_template("public/add_scrape_task.html", message=message, jobs=jobs)
